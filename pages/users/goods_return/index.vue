...
<style scoped lang="scss">
	...
	.apply-return .list .item .upload .pictrue .icon-ic_close2{position:absolute;font-size:45rpx;top:-10rpx;right:-10rpx;}
	.apply-return .list .item .upload .pictrue .icon-ic_camera1{color:#bfbfbf;font-size:50rpx;}
