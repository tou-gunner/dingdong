<template>
	...
	<view>
		<view class="list">
			<view class="times">
				<view class="item acea-row row-center row-middle" :class="time == 'all' ? 'on' : ''" @click="setTime('all')">全部</view>
				<view class="item acea-row row-center row-middle" :class="time == 'today' ? 'on' : ''" @click="setTime('today')">今日</view>
				<view class="item acea-row row-center row-middle" :class="time == 'yesterday' ? 'on' : ''" @click="setTime('yesterday')">昨日</view>
				<view class="item acea-row row-center row-middle" :class="time == 'seven' ? 'on' : ''" @click="setTime('seven')">近7日</view>
			</view>
