		...
		<view class='logistics'>
			<view class='header acea-row row-between row-top'>
				...
				<view class='text acea-row row-between'>
					...
					<view class='money'>
						<view>{{orderInfo.total_price}}ຄະແນນ</view>
			...
			<view class='logisticsCon'>
				<view class='company acea-row row-between-wrapper'>
					<view class='picTxt acea-row row-between-wrapper'>
						...
						<view class='text'>
							<view><text class='name line1'>ບໍລິສັດຂົນສົ່ງ：</text> {{orderInfo.delivery_name}}</view>
							<view class='express line1'><text class='name'>ເລກພັດສະດຸ：</text> {{orderInfo.delivery_id}}</view>
						</view>
					</view>
					<!-- #ifndef H5 -->
					<view class='copy' @tap='copyOrderId'>ສຳເນົາ</view>
					<!-- #endif -->
					<!-- #ifdef H5 -->
					<view class='copy copy-data' :data-clipboard-text="orderInfo.delivery_id">ສຳເນົາ</view>
					<!-- #endif -->
				</view>
