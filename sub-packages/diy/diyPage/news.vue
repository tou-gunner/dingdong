<template>
	<!-- 新闻播报 -->
	<view :style="[newsStyle]" v-if="newsList.length" class="relative news-box">
...
<script>
	...
	export default {
		...
		computed: {
			newsStyle() {
				return {
					margin: `${this.dataConfig.topConfig.val * 2}rpx ${this.dataConfig.prConfig.val * 2}rpx ${this.dataConfig.bottomConfig.val * 2}rpx`,
					marginTop: diyUtil.buildMarginTopOffset(this.dataConfig.mbConfig, this.dataConfig.offsetTopConfig),
