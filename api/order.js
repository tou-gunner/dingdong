 ...
 * @returns 
 */
export function computedRefundPrice(data) {
  return request.post("refund/compute", data);
}
 ...
 * 
*/
export function getDeliveryStationListApi(data){
  return request.get('order/deliveryStation/list', data)
}
 ...
 * 
*/
export function getDeliverySettingsDataApi(data){
  return request.get(`order/deliverySetings`, data)
}
 ...
 * @param object data
*/
export function getCashierOrder(id){
  return request.get(`order/cashier_order/${id}`);
}
/**
 * 获取订单支付方式列表
 * @param object data
*/
export function getOrderPayTypeList(data){
  return request.get(`pay/config`, data);
}
/**
 * 退款--平台接入
 * @param object data
*/
export function platformIntervention(id){
  return request.post(`refund/platform/${id}`);
}
